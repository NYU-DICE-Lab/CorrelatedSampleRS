...
singularity exec --nv \
	...
	/bin/bash -c "source /ext3/env.sh; python3 infer_certify_video.py UCF101 -si 524 -o vidtest_max/ -dpath /scratch/mp5847/UCF-101/ -sigma $SIGMA -mp $MODEL_PATH --frame_dir /scratch/mp5847/dataset/UCF-101_extracted_frames/ --annotation_path /home/mp5847/src/MARS/annotation/ucfTrainTestlist --sample_duration 16 -cs 16 -cstr 16 -rs -ns 6 -rm $RM --N 100 --N0 1000 --batch 15 --only_RGB"
