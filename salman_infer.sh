...
python smoothadv/certify.py  imagenet salman_models/pretrained_models/imagenet/PGD_1step/imagenet/eps_2048/resnet50/noise_1.00/checkpoint.pth.tar $SIGMA certify_results_salman_model --max 100 --N0 100 --N 10000 --batch 300